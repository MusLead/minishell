...
// TODO .md: each comments that I use `// >` seperate them in .md file
// TODO: MAKE SURE EVEYRTHING IN ENGLISH!
// TODO: after the test, the shell might not be terminated, therfore create a 
